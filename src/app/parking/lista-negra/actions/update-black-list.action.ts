...
import { BlackListUsecase, IUpdateBlackListParamsEntity } from "@/server/domain";
...
export async function updateBlackListAction(
  id: string,
  params: IUpdateBlackListParamsEntity,
  ...
  try {
    ...
    return {
      ...
      error:
        ...
        "Error al actualizar registro de lista negra",
    };
  }
}
