...
import { MasterKeysUsecase, ICreateMasterKeyParamsEntity } from "@/server/domain";
...
export async function createMasterKeyAction(
  params: ICreateMasterKeyParamsEntity,
