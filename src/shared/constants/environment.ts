export const ENVIRONMENT = {
    ...
    PAYMENT_TICKET_PRINTER_API_URL: process.env.NEXT_PUBLIC_PAYMENT_TICKET_PRINTER_API_URL || "http://localhost:8080",
    PAYMENT_TICKET_PRINTER_ENDPOINT: process.env.NEXT_PUBLIC_PAYMENT_TICKET_PRINTER_ENDPOINT || "/print",
};